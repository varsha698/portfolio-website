...
<motion.h1
  className="pt-24 text-5xl md:text-6xl font-bold text-center bg-clip-text text-transparent bg-gradient-to-r from-amber-400 to-orange-500 drop-shadow-lg tracking-wide"
