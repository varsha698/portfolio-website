...
const timeline = [
  {
    ...
    desc: "Pursuing B.S. in Computer Science at University of Minnesota Duluth. Relevant coursework includes Software Engineering, Operating Systems, Computer Security, Natural Language Processing, and Mobile UX/UI Design.",
    iconPath: "umd_logo.png",
    path: "https://www.d.umn.edu/",
  },
  {
    year: "Feb 2025 – Present",
    title: "Healthcare Software Data Abstractor",
    desc: "At St. Luke’s Aspirus Administration, assisting in migrating patient data from Meditech to Epic, ensuring accuracy, validation, and HIPAA compliance.",
    iconPath: "stlukes_logo.png",
    path: "https://www.slhduluth.com/",
  },
  {
    year: "Sept 2024 – Present",
    title: "Undergraduate Research Assistant",
    desc: "Researching mental well-being and gamified mobile app development for stress management among college students at UMD.",
    iconPath: "umd_research_logo.png",
    path: "https://www.d.umn.edu/",
  },
  {
    year: "Aug 2024 – Present",
    title: "Intern - International Student Services",
    desc: "Managing confidential student records with Sunapsis, assisting international students with onboarding and orientation support at UMD.",
