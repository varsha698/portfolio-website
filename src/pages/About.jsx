        ...
        {timeline.map((event, index) => (
          ...
          >
            ...
            <div className="absolute z-20 w-16 h-16 flex items-center justify-center md:left-1/2 md:transform md:-translate-x-1/2 left-0">
              <motion.div
                className="w-16 h-16 rounded-full bg-gray-900 border-2 border-amber-500/50 overflow-hidden relative"
              ...
              >
                ...
                >
                  <img
                    src={`${import.meta.env.BASE_URL}${event.iconPath}`}
                    alt={`${event.title} icon`}
                    className="w-12 h-12 object-contain rounded-full"
                    style={{ padding: "4px", backgroundColor: "#fff" }}
                    onError={(e) => {
                      e.target.onerror = null;
                      e.target.src = `${import.meta.env.BASE_URL}fallback-icon.png`;
                    }}
                  />
                </a>
            ...
            >
              ...
              >
                ...
                <p className="text-sm italic text-orange-400 mb-2">
                  {event.year}
                </p>
